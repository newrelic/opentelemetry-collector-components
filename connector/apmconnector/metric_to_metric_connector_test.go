...
func TestExponentialHistogramUnitConversion(t *testing.T) {
	...
	assert.Equal(t, uint64(1), newDp.Positive().BucketCounts().At(0))  // (0.000345, 0.000488] (index -23)
	assert.Equal(t, uint64(0), newDp.Positive().BucketCounts().At(1))  // (0.000488, 0.000691] (index -22)
	assert.Equal(t, uint64(2), newDp.Positive().BucketCounts().At(2))  // (0.000691, 0.000977] (index -21)
	assert.Equal(t, uint64(3), newDp.Positive().BucketCounts().At(3))  // (0.000977, 0.001381] (index -20)
	assert.Equal(t, uint64(0), newDp.Positive().BucketCounts().At(4))  // (0.001381, 0.001953] (index -19)
	assert.Equal(t, uint64(4), newDp.Positive().BucketCounts().At(5))  // (0.001953, 0.002762] (index -18)
	assert.Equal(t, uint64(0), newDp.Positive().BucketCounts().At(6))  // (0.002762, 0.003906] (index -17)
	assert.Equal(t, uint64(0), newDp.Positive().BucketCounts().At(7))  // (0.003906, 0.005524] (index -16)
	assert.Equal(t, uint64(0), newDp.Positive().BucketCounts().At(8))  // (0.005524, 0.007813] (index -15)
	assert.Equal(t, uint64(0), newDp.Positive().BucketCounts().At(9))  // (0.007813, 0.011049] (index -14)
	assert.Equal(t, uint64(0), newDp.Positive().BucketCounts().At(10)) // (0.011049, 0.015625] (index -13)
	assert.Equal(t, uint64(0), newDp.Positive().BucketCounts().At(11)) // (0.015625, 0.022097] (index -12)
	assert.Equal(t, uint64(0), newDp.Positive().BucketCounts().At(12)) // (0.022097, 0.031250] (index -11)
	assert.Equal(t, uint64(0), newDp.Positive().BucketCounts().At(13)) // (0.031250, 0.044194] (index -10)
	assert.Equal(t, uint64(1), newDp.Positive().BucketCounts().At(14)) // (0.044194, 0.062500] (index -9)
}
